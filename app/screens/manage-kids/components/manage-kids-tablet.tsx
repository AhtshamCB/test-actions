...
export const ManageKidsTablet = ({route}) => {
          ...
          <View style={{flexDirection: 'row'}}>
            <View>
              {activeKidInfo?.activeFor?.info && (
                <View
                  ...
                  {getMemberShipStatus() ===
                    MEMBER_SHIP_STATUS.STILL_ACTIVE && (
                    <View style={FINISH_ICON_VIEW}>
                      <FinishIcon props={undefined} />
                    </View>
                  )}
                  <View
                    ...
                    <TouchableOpacity
                      ...
                      style={{
                        alignItems: 'flex-end',
                        marginTop:
                          orientation === 'PORTRAIT' ? verticalScale(0) : 0,
                        zIndex: 100,
                      }}>
            ...
            <View
                ...
                CONTENT,
                {
                  width:
                    orientation === 'PORTRAIT'
                      ...
                      ? horizontalScale(180)
                      : horizontalScale(230),
                  height: orientation === 'PORTRAIT' ? 'auto' : 'auto',
                    ...
                    INPUT_USER_NAME,
                    {
                      height:
                        orientationOpenApp === 'LANDSCAPE'
                          ? verticalScale(50)
                          : verticalScale(35),
                      borderColor: errors ? color.red : color.gray4,
                      borderWidth: 1,
                    },
                  ]}
              ...
              <View
                style={[
                  BUTTON_VIEW,
                  {padding: 0, marginTop: verticalScale(0)},
                ]}>
                <ButtonBorder
