...
export const ManageStudentsLandscapeTablet = ({route}) => {
        ...
        {dataListStudents?.data?.length > 0 ? (
          <DataTable>
            <DataTable.Header
              ...
              <TouchableOpacity
                style={{flex: orientationOpenApp === 'LANDSCAPE' ? 0.5 : 1}}>
                <DataTable.Title
                  textStyle={[
                    TITLE_TEXT,
                    {
                ...
                renderItem={({item, index}) => {
                  return (
                    <View key={index} style={FLALIST_CONTENT}>
                      <View
                        style={{
                          flex: orientationOpenApp === 'LANDSCAPE' ? 0.5 : 0.8,
                        }}>
                        <Text
                          text={`#${item.rank}`}
                          style={[
                ...
                renderItem={({item, index}) => {
                  return (
                    <View key={index} style={FLALIST_CONTENT}>
                      <View
                        style={{
                          flex: orientationOpenApp === 'LANDSCAPE' ? 0.2 : 0.1,
                        }}>
                        <Text
                          text={`#${item.rank}`}
                          style={[
                ...
                <Tooltip
                  ...
                  content={
                    <Text
                      ...
                      for your teacher to login and manage students. The teacher
                      can add students, change password, and update avatar on
                      their dashboard.{' '}
                    </Text>
                  }
                  placement="bottom"
