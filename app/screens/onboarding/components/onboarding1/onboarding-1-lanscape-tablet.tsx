  ...
  return (
    <View style={CONTAINER_VIEW}>
      ...
      <ImageBackground
        ...
        <Text
          text={"Your Child's Financial Journey Begins Here."}
          style={{...DESCRIPTION, fontSize: moderateScale(12)}}
        />

        <View style={BUTTON_CONTAINER}>
          <Dot activeDot={0} dotsCount={4} props={undefined} />
