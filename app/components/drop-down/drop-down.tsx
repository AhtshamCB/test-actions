...
import CInput from './components/text-input/text-input';
import {styles} from './styles';

const {isTablet} = useDetectDevice;
const ic_down = require('./images/down.png');
      ...
      return (
        <TouchableWithoutFeedback
          ...
          <View>
            ...
            <>
              {isTablet ? (
                <View style={styles.dropdownTabletContainer}>
                  <Text
                ...
                <View style={styles.dropdownPhoneContainer}>
                  <Text
                    numberOfLines={numberOfLines}
                    style={[
                      styles.textItem,
